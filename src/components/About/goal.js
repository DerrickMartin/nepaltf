...
export default function GoalSection() {
    return (
        <div className="goal-section">
            ...
            <p>
                We believe that by providing a space for athletes to share their stories, we can inspire the next generation of Nepali athletes to follow in their footsteps and achieve their dreams.
            </p>
        </div>
    )
}